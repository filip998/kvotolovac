...
export const mockBookmakers: Bookmaker[] = [
  ...
  { id: 'starbet', name: 'StarBet', is_active: true },
];
...
export const mockMatches: Match[] = [
  {
    ...
    start_time: hours(2),
    status: 'upcoming',
    resolved_event_id: 'evt_mock_oly_real',
  ...
  },
  {
    ...
    status: 'upcoming',
    resolved_event_id: 'evt_mock_djokovic_alcaraz',
    available_bookmakers: [
      { id: 'maxbet', name: 'MaxBet' },
      { id: 'balkanbet', name: 'BalkanBet' },
    ],
...
export const mockOutcomeOffers: OutcomeOffer[] = [
  ...mockFootballOutcomeOffers,
  { id: 1201, match_id: 'tennis-match-1', bookmaker_id: 'maxbet', bookmaker_name: 'MaxBet', market_type: 'tennis_match_winner', outcome_code: 'home', odds: 2.15, line: null, raw_label: '1', scraped_at: ago(2) },
  { id: 1202, match_id: 'tennis-match-1', bookmaker_id: 'maxbet', bookmaker_name: 'MaxBet', market_type: 'tennis_match_winner', outcome_code: 'away', odds: 1.72, line: null, raw_label: '2', scraped_at: ago(2) },
  { id: 1203, match_id: 'tennis-match-1', bookmaker_id: 'balkanbet', bookmaker_name: 'BalkanBet', market_type: 'tennis_match_winner', outcome_code: 'home', odds: 1.82, line: null, raw_label: '1', scraped_at: ago(2) },
  { id: 1204, match_id: 'tennis-match-1', bookmaker_id: 'balkanbet', bookmaker_name: 'BalkanBet', market_type: 'tennis_match_winner', outcome_code: 'away', odds: 2.05, line: null, raw_label: '2', scraped_at: ago(2) },
];
...
export const mockMatchOutcomeOfferScopes: Record<string, string[]> = {
  ...
  'tennis-match-1': ['tennis-match-1'],
};

export const mockEvents: EventDetail[] = [
  {
    id: 'evt_mock_oly_real',
    sport: 'basketball',
    start_time: hours(2),
    ...
    display_home_team: 'Olympiacos',
    display_away_team: 'Real Madrid',
    ...
    members: [
      {
        ...
        status: 'active',
        source_url: null,
        source_league_id: 'euroleague',
        source_league_name: 'EuroLeague',
        source_home_team: 'Olympiacos',
        source_away_team: 'Real Madrid',
        source_start_time: hours(2),
        evidence: [],
        metadata: {},
        created_at: ago(10),
        updated_at: ago(2),
      },
      {
        ...
        source_league_id: 'euroleague',
        source_league_name: 'EuroLeague',
        source_home_team: 'Olympiacos BC',
        source_away_team: 'Real Madrid Baloncesto',
        source_start_time: hours(2),
        evidence: [],
        metadata: {},
        created_at: ago(10),
      ...
      },
      {
        ...
        confidence: 0.97,
        status: 'active',
        source_url: 'https://www.maxbet.rs/sr/pocetna#/sport/event/23281441',
        source_league_id: 'euroleague',
        source_league_name: 'EuroLeague',
        source_home_team: 'Olympiacos BC',
        source_away_team: 'Real Madrid Baloncesto',
    ...
    players: [
      {
        key: 'ply_mock_sasha',
        display_name: 'Sasha Vezenkov',
        source_variants: ['Sasha Vezenkov', 'S. Vezenkov'],
      },
      {
        key: 'ply_mock_facundo',
        display_name: 'Facundo Campazzo',
        source_variants: ['Facundo Campazzo', 'F. Campazzo'],
      },
    ],
    created_at: ago(10),
    updated_at: ago(2),
  ...
  {
    id: 'evt_mock_djokovic_alcaraz',
    sport: 'tennis',
    start_time: hours(4.5),
    primary_match_id: 'tennis-match-1',
    status: 'active',
    confidence: 0.99,
    method: 'auto_exact',
    display_home_team: 'Novak Djokovic',
    display_away_team: 'Carlos Alcaraz',
    display_league_name: 'ATP Dubai',
    metadata: {},
    members: [
      {
        id: 10,
        ...
        confidence: 0.99,
        status: 'active',
        source_url: 'https://www.maxbet.rs/sr/pocetna#/sport/event/23401849',
        source_league_id: 'atp_dubai',
        source_league_name: 'ATP Dubai',
        source_home_team: 'Novak Djokovic',
        source_away_team: 'Carlos Alcaraz',
        source_start_time: hours(4.5),
        evidence: [],
        metadata: {},
        created_at: ago(10),
        updated_at: ago(2),
...
export const mockEventOddsOffers: EventOddsOffer[] = [
  {
    id: 9001,
    match_id: 'match-1',
    bookmaker_id: 'mozzart',
    ...
    under_odds: 1.95,
    scraped_at: ago(5),
    event_scoped_player_key: 'ply_mock_sasha',
    event_player_display_name: 'Sasha Vezenkov',
  },
  {
    id: 9002,
    match_id: 'match-1-rich',
  ...
  },
  {
    ...
    under_odds: 1.88,
    scraped_at: ago(5),
    event_scoped_player_key: 'ply_mock_facundo',
    event_player_display_name: 'Facundo Campazzo',
  },
  {
    id: 9005,
    match_id: 'match-1-rich',
  ...
  },
  {
    ...
    under_odds: 1.92,
    scraped_at: ago(4),
    event_scoped_player_key: null,
    event_player_display_name: null,
  },
];
...
export const mockOpportunities: Opportunity[] = [
  {
    ...
    legs: [
      { match_id: 'match-1', bookmaker_id: 'mozzart', bookmaker_name: 'Mozzart', market_type: 'player_points', outcome_code: 'over', odds: 1.85, line: 18.5, raw_label: '18.5+' },
      { match_id: 'match-1-rich', bookmaker_id: 'meridian', bookmaker_name: 'Meridian', market_type: 'player_points', outcome_code: 'under', odds: 1.9, line: 20.5, raw_label: '20.5-' },
    ],
    detected_at: ago(3),
    is_active: true,
  },
  ...
  },
  {
    ...
    legs: [
      { bookmaker_id: 'maxbet', bookmaker_name: 'MaxBet', market_type: 'tennis_match_winner', outcome_code: 'home', odds: 2.15, line: null, raw_label: '1' },
      { bookmaker_id: 'balkanbet', bookmaker_name: 'BalkanBet', market_type: 'tennis_match_winner', outcome_code: 'away', odds: 2.05, line: null, raw_label: '2' },
    ],
    detected_at: ago(2),
    is_active: true,
  },
...
export const mockOddsOffers: OddsOffer[] = [
  ...
  // StarBet — bulk preview shape: one player_points threshold per player + plain regulation game_total.
  { id: 50, match_id: 'match-1', bookmaker_id: 'starbet', bookmaker_name: 'StarBet', source_url: 'https://starbet.rs/Bet', market_type: 'player_points', player_name: 'Sasha Vezenkov', threshold: 18.5, over_odds: 1.85, under_odds: 1.95, scraped_at: ago(2) },
  { id: 51, match_id: 'match-1', bookmaker_id: 'starbet', bookmaker_name: 'StarBet', source_url: 'https://starbet.rs/Bet', market_type: 'game_total', player_name: null, threshold: 158.5, over_odds: 1.90, under_odds: 1.90, scraped_at: ago(2) },
  { id: 52, match_id: 'match-2', bookmaker_id: 'starbet', bookmaker_name: 'StarBet', source_url: 'https://starbet.rs/Bet', market_type: 'player_points', player_name: 'Nigel Hayes-Davis', threshold: 16.5, over_odds: 1.86, under_odds: 1.94, scraped_at: ago(1) },
...
export const mockSystemStatus: SystemStatus = {
  ...
  bookmaker_status: [
    ...
    { id: 'starbet', name: 'StarBet', last_scrape: ago(3), is_active: true },
  ],
};
...
export const mockScrapeSettings: ScrapeSettingsResponse = {
  applied: {
    ...
    min_fitted_middle_ev_percent: 0,
  ...
  options: {
    ...
    min_fitted_middle_ev_percent_min: 0,
    min_fitted_middle_ev_percent_max: 100,
