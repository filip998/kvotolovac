...
export const mockOddsOffers: OddsOffer[] = [
  ...
  { id: 33, match_id: 'match-1', bookmaker_id: 'volcanobet', bookmaker_name: 'VolcanoBet', source_url: 'https://www.volcanobet.rs/sport-v2/prematch/events', market_type: 'player_points', player_name: 'Sasha Vezenkov', threshold: 19.0, over_odds: 1.86, under_odds: 1.92, scraped_at: ago(2) },
  { id: 34, match_id: 'match-1', bookmaker_id: 'volcanobet', bookmaker_name: 'VolcanoBet', source_url: 'https://www.volcanobet.rs/sport-v2/prematch/events', market_type: 'game_total_ot', player_name: null, threshold: 157.5, over_odds: 1.89, under_odds: 1.88, scraped_at: ago(2) },
  { id: 35, match_id: 'match-2', bookmaker_id: 'volcanobet', bookmaker_name: 'VolcanoBet', source_url: 'https://www.volcanobet.rs/sport-v2/prematch/events', market_type: 'player_points', player_name: 'Nigel Hayes-Davis', threshold: 16.0, over_odds: 1.87, under_odds: 1.91, scraped_at: ago(1) },
];
