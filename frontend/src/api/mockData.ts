...
export const mockMatchingReviewCases: MatchingReviewCase[] = [
  {
    id: 1,
    ...
    suggested_league_name: 'Bulgaria NBL',
    match_id: 'review-match-1',
    ...
    confidence: 'high',
    evidence: [
      'Event slot: Rilski Sportist vs Levski Sofia',
      `Exact start time: ${hours(2.5)}`,
      'League votes: Bulgaria NBL x2, NBL x1',
    ],
    status: 'pending',
    scraped_at: ago(2),
  },
  {
    ...
    bookmaker_id: 'maxbet',
    bookmaker_name: 'MaxBet',
    raw_league_id: 'Bugarska 1',
    normalized_raw_league_id: 'bugarska 1',
    suggested_league_id: 'bulgaria_nbl',
    suggested_league_name: 'Bulgaria NBL',
    match_id: 'review-match-1',
    home_team: 'Rilski Sportist',
    away_team: 'Levski Sofia',
    start_time: hours(2.5),
    reason_code: 'league_conflict_resolved_by_event_context',
    confidence: 'medium',
    evidence: [
      'Event slot: Rilski Sportist vs Levski Sofia',
      `Exact start time: ${hours(2.5)}`,
      'League votes: Bulgaria NBL x2, Bugarska 1 x1',
    ],
    status: 'approved',
    scraped_at: ago(2),
  },
  {
    ...
    bookmaker_id: 'admiralbet',
    bookmaker_name: 'AdmiralBet',
    raw_league_id: 'ABA Liga Winners Stage',
    normalized_raw_league_id: 'aba liga winners stage',
    suggested_league_id: 'aba_liga',
    suggested_league_name: 'ABA League',
    match_id: 'review-match-2',
    home_team: 'Dubai',
    away_team: 'Budućnost',
    start_time: hours(1.5),
    reason_code: 'league_inferred_from_event_context',
    confidence: 'high',
    evidence: [
      'Event slot: Dubai vs Budućnost',
      `Exact start time: ${hours(1.5)}`,
      'League votes: ABA League x3, ABA Liga Winners Stage x1',
    ],
    status: 'pending',
    scraped_at: ago(2),
  },
...
export const mockMatchingReviewSummary: MatchingReviewSummary = {
  total_matches: 6,
  leagues_with_matches: 3,
  pending_reviews: 2,
  approved_reviews: 1,
  inferred_events: 2,
  leagues: [
